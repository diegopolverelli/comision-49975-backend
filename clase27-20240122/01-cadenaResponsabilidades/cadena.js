...
const procesaProducto=(producto, ...operaciones)=>{ // operador rest ...
...
console.log(procesaProducto(producto1, validaProducto, desc1, desc2, (producto)=>{
    if(producto.precio>180){
        console.log(`- aplica 10% dto PROMO VERANO`)
