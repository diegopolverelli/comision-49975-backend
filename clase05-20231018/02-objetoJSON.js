...
const archivo="./archivos/heroes.json"
...
fs.writeFileSync(archivo, JSON.stringify(heroes, null, "\t"))

let lecturaTXT=fs.readFileSync(archivo, "utf-8")
lecturaOBJ=JSON.parse(lecturaTXT)
console.log(lecturaOBJ)

let heroesLeidos=JSON.parse(fs.readFileSync(archivo, "utf-8"))
